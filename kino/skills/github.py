...
class GithubManager(object):
    ...
    def commit(self, timely="daily"):
        if timely == "daily":
            ...
            if commit_count == 0:
                ...
                self.slackbot.send_message(text=MsgResource.GITHUB_COMMIT_EXIST + str(commit_count))
            ...
            self.plot.make_bar(date, commit_count_list, f_name, x_ticks=x_ticks, y_ticks=y_ticks,
    ...
    def __time_point(self, days):
        ...
        point_date = datetime.datetime(point_date.year, point_date.month, point_date.day)
